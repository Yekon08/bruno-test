  ...
  return (
    <section className="w-full h-full pt-24 bgHero">
      <Image
        ...
        width={340}
        height={460}
        className="hidden md:block absolute right-[10%] top-0"
      />

      <div className="px-6 md:px-0 md:w-desktop mx-auto mb-6 md:mb-24">
      ...
      <div className="px-6 md:px-0 md:w-desktop mx-auto flex flex-col gap-6 md:gap-0 md:flex-row items-center justify-normal md:justify-between">
         {cardHero(true)}
        <div
          className={`relative w-full h-[260px] md:w-[${slice.primary.leftimg.dimensions.width}px] md:h-[${slice.primary.leftimg.dimensions.height}px]`}
        >
          <Image
        ...
        <div className="relative w-full md:w-auto">
          {cardHero()}
          <div
            className={`relative w-full h-[260px] md:w-[${slice.primary.rightimg.dimensions.width}px] md:h-[${slice.primary.rightimg.dimensions.height}px]`}
          >
            <Image
              src={slice.primary.rightimg.url}
              alt={slice.primary.rightimg.alt || "Right presentation image"}
              fill
              className="rounded-[24px] z-0"
            />
          </div>
        </div>
      </div>
